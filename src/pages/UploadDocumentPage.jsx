...
const UploadDocumentPage = () => {
  ...
  const [formData, setFormData] = useState({
    documentType: '',
    documentName: '',
    type: '', // This seems generic, might be 'National', 'International' etc.
    volumeIssuesPages: '',
    publicationName: '',
    date: '',
    achievementsRemarks: '',
    documentVisibleTo: 'Admin Only', // Default value
    file: null,
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Document Upload Form Submitted:", formData);
    alert("Document upload simulated! (Check console for data)");
  ...
  return (
    <div className="flex h-screen bg-gray-100 text-gray-800">
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-gray-200">
        ...
        {/* Page Content - Upload Document Form */}
        <div className="flex-1 overflow-x-hidden overflow-y-auto p-6 flex justify-center items-start">
          <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="volumeIssuesPages" className="block text-sm font-medium text-gray-700 mb-1">Volume, Issues & Pages</label>
                <input
                  type="text"
                  id="volumeIssuesPages"
                  name="volumeIssuesPages"
                  value={formData.volumeIssuesPages}
                  onChange={handleChange}
                  placeholder="e.g., Vol 2, Issue 1, pgs 10-20"
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-400 focus:border-blue-400"
                />
              </div>

              <div>
                <label htmlFor="publicationName" className="block text-sm font-medium text-gray-700 mb-1">Name of the Publication</label>
                <input
                  type="text"
                  id="publicationName"
              ...
              <div>
                <label htmlFor="achievementsRemarks" className="block text-sm font-medium text-gray-700 mb-1">Achievements/Remarks</label>
                <textarea
                  id="achievementsRemarks"
                  name="achievementsRemarks"
                  value={formData.achievementsRemarks}
                  onChange={handleChange}
                  rows="3"
              ...
              <div>
                <label htmlFor="documentVisibleTo" className="block text-sm font-medium text-gray-700 mb-1">Document Visible To</label>
                <select
                  id="documentVisibleTo"
                  name="documentVisibleTo"
                  value={formData.documentVisibleTo}
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-400 focus:border-blue-400"
                >
              ...
              <div className="flex justify-end space-x-4 mt-6">
                <button
                  ...
                  onClick={() => console.log('Discard changes clicked')} // You can add actual discard logic here
                >
                  Discard
                </button>
                <button
